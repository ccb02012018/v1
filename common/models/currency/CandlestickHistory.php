 ...
 * @property int $can_his_volume
 * @property double $can_his_quote_asset_volume BTC volume
 * @property int $can_his_number_trades
 * @property double $can_his_tb_base_asset_volume taker buy Cantidad
 * @property double $can_his_tb_quote_asset_volume Taker buy precio
...
class CandlestickHistory extends \yii\db\ActiveRecord
{
	...
	{
		return [
			[['can_his_exc_id', 'can_his_cur_id', 'can_his_typ_can_id', 'can_his_open_time', 'can_his_open', 'can_his_high', 'can_his_low', 'can_his_close', 'can_his_close_time', 'can_his_volume', 'can_his_quote_asset_volume', 'can_his_number_trades', 'can_his_tb_base_asset_volume', 'can_his_tb_quote_asset_volume'], 'required'],
			[['can_his_exc_id', 'can_his_cur_id', 'can_his_typ_can_id', 'can_his_open_time', 'can_his_close_time', 'can_his_volume', 'can_his_number_trades'], 'integer'],
	...
	public function attributeLabels()
	{
		return [
			...
			'can_his_volume' => Yii::t('app', 'Can His Volumen Int'),
